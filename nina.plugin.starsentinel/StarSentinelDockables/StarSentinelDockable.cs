...
namespace Michelegz.NINA.StarSentinel.StarSentinelDockables {
    /// <summary>
    ...
    public class StarSentinelDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public StarSentinelDockable(
            ...
            dict.Source = new Uri("Michelegz.NINA.StarSentinel;component/StarSentinelDockables/StarSentinelDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Michelegz.NINA.StarSentinel_AltitudeSVG"];
