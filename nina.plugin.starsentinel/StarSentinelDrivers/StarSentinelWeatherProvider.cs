...
namespace Michelegz.NINA.StarSentinel.StarSentinelDrivers {
    /// <summary>
    ...
    public class StarSentinelWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public StarSentinelWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "StarSentinel";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new StarSentinelWeatherDriver("MyUniqueId", "MyDeviceId"));
