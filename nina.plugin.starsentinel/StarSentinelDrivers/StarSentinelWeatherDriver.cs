...
namespace Michelegz.NINA.StarSentinel.StarSentinelDrivers {
    ...
    /// </summary>
    public class StarSentinelWeatherDriver : BaseINPC, IWeatherData {
        public StarSentinelWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"StarSentinel Weather Data ({deviceId})";
        ...
        public string Category => "StarSentinel Weather Driver";
