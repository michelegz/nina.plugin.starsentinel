...
namespace Michelegz.NINA.StarSentinel.StarSentinelTestCategory {
    ...
    public class StarSentinelCondition : SequenceCondition {
        /// <summary>
        ...
        public override object Clone() {
            return new StarSentinelCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(StarSentinelCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}