...
namespace Michelegz.NINA.StarSentinel.StarSentinelTestCategory {
    ...
    public class StarSentinelInstruction : SequenceItem {
        /// <summary>
        ...
        public StarSentinelInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public StarSentinelInstruction(StarSentinelInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new StarSentinelInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(StarSentinelInstruction)}, Text: {Text}";
        }
    }
}