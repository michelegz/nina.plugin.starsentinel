...
namespace Michelegz.NINA.StarSentinel.StarSentinelTestCategory {
    ...
    public class StarSentinelTrigger : SequenceTrigger {
        /// <summary>
        ...
        public StarSentinelTrigger() {
        }

        public override object Clone() {
            return new StarSentinelTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(StarSentinelTrigger)}";
        }
    }
}