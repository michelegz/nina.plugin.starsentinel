...
namespace Michelegz.NINA.StarSentinel {
    ...
    public class StarSentinel : PluginBase, INotifyPropertyChanged {
        ...
        private readonly ImagePattern exampleImagePattern = new ImagePattern("$$EXAMPLEPATTERN$$", "An example of an image pattern implementation", "Star Sentinel");

        [ImportingConstructor]
        public StarSentinel(IProfileService profileService, IOptionsVM options, IImageSaveMediator imageSaveMediator) {
